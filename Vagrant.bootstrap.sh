...
# limpieza de configuración del dominio aplicacion-devops.localhost es nuestro nodo agente.
# en nuestro caso es la misma máquina
sudo puppet node clean aplicacion-devops.localhost

# Habilito el agente
sudo puppet agent --certname aplicacion-devops.localhost --enable
