...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "aplicacion-devops.localhost"
  ...
  config.vm.provision "file", source: "Config/ufw", destination: "/tmp/utw"
  config.vm.provision "file", source: "Config/etc_hosts.txt", destination: "/tmp/etc_hosts.txt"
  # Archivos de Puppet
  config.vm.provision "file", source: "Config/puppet/site.pp", destination: "/tmp/site.pp"
  config.vm.provision "file", source: "Config/puppet/init.pp", destination: "/tmp/init.pp"
  config.vm.provision "file", source: "Config/puppet/init_jenkins.pp", destination: "/tmp/init_jenkins.pp"
  config.vm.provision "file", source: "Config/puppet/puppet-master.conf", destination: "/tmp/puppet-master.conf"
  config.vm.provision "file", source: "Config/puppet/.env", destination: "/tmp/env"
  # Archivo para Jenkins
  config.vm.provision "file", source: "Config/jenkins/default_jenkins", destination: "/tmp/jenkins_default"
  config.vm.provision "file", source: "Config/jenkins/init_d", destination: "/tmp/jenkins_init_d"
